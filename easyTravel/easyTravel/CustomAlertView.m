   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.backgroundColor = [CommonUtil getColor:@"93d577"];
        UIView *forground = [[UIView alloc] initWithFrame:CGRectMake(1, 3, kAlertWidth-2, kAlertHeight-5)];
        forground.backgroundColor = [UIColor whiteColor];
        [self addSubview:forground];
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(1,forground.bounds.size.height/2.0f, forground.bounds.size.width,1.0f)];
        line.backgroundColor = [CommonUtil getColor:@"dcdcdc"];
        [forground addSubview:line];
        
        
        UIImageView *light = [[UIImageView alloc] initWithFrame:CGRectMake(40, 20, 20, 20)];
        light.image = [UIImage imageNamed:@"light.png"];
        [self addSubview:light];
        self.alertTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, kTitleYOffset, kAlertWidth, kTitleHeight)];
        self.alertTitleLabel.font = [UIFont systemFontOfSize:20.0f];
        self.alertTitleLabel.textColor = [UIColor colorWithRed:0x44/255.0 green:0x44/255.0 blue:0x44/255.0 alpha:1];
...
#define kButtonBottomOffset 30.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:0xff/255.0 green:0x94/255.0 blue:0x9f/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:0x93/255.0 green:0xd5/255.0 blue:0x77/255.0 alpha:1]] forState:UIControlStateNormal];
        ...
        self.leftBtn.layer.cornerRadius = self.rightBtn.layer.cornerRadius = 6.0;

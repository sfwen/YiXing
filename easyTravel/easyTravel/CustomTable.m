...
- (void)addRecord: (NSArray*)record {
    ...
    for(uint i=0; i<record.count; i++){
        ...
        [col1.layer setBorderColor:[[CommonUtil getColor:@"dcdcdc"] CGColor]];
        [col1.layer setBorderWidth:1.0];
		col1.font = [UIFont fontWithName:@"Helvetica" size:15.0];
        col1.textColor = [CommonUtil getColor:@"333333"];
		col1.frame = rect;

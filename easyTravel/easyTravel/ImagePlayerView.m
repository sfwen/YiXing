...
- (void)_init
{
    ...
    self.pageControl.pageIndicatorTintColor = [CommonUtil getNavigationBarBgColor];
...
- (void)setPageControlPosition:(ICPageControlPosition)pageControlPosition
{
    ...
    switch (pageControlPosition) {
        ...
        case ICPageControlPosition_BottomRight: {
            vFormat = @"V:[pageControl]-15-|";
            hFormat = @"H:|-250-[pageControl]|";
            break;
        }
...
-(void)drawRect:(CGRect)rect{
    //[image drawInRect:CGRectMake(rect.origin.x, rect.size.width-2, rect.size.width, 2)];
}
@end

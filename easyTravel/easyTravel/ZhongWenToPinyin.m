...
char pinyin1stLetter(unsigned short hanzi) {
...
@implementation ZhongWenToPinyin

+ (NSString *) pinyinFromZhongWenString:(NSString *)string {
...
+ (char) sectionTitle:(NSString *)string {
	int cLetter = 0;
	if( !string || 0 == [string length] )
		...
		if(([string characterAtIndex:0] > 64 && [string characterAtIndex:0] < 91) || 
		   ([string characterAtIndex:0] > 96 && [string characterAtIndex:0] < 123) ) {
			...
			cLetter = pinyin1stLetter((unsigned short)[string characterAtIndex:0]);
